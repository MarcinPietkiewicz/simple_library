...
class Book(BaseModel):
    ...
    description = CharField(max_length=100, column_name='book_description', null=True)
    publisher = ForeignKeyField(Publisher, column_name='book_publisher_id', null=False)
    authors = ManyToManyField(Author, backref='books') # tutaj robimy book_author - tabela łącząca
